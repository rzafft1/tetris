...
class GameUI:
    ...
    def __init__(self, difficulty: int = 1):
        ...
        self.padding_grid_border = int(screen_w * 0.01)
        self.width_grid_border = self.width_grid_container + (self.padding_grid_border * 2) 
        self.height_grid_border = self.height_grid_container + (self.padding_grid_border * 2) 

        # Sidebar container
        self.width_sidebar_container = self.size_block * 6
        self.height_sidebar_container = self.height_grid_border

        # Window width
        self.width_window = (
            self.width_grid_border + self.width_sidebar_container +
    ...
    def draw_ui(self) -> None:
        ...
        # ===============================
        gridborder_x = self.padding_grid["left"]
        gridborder_y = (self.height_window - self.height_grid_border) // 2
        gridborder_rect = pygame.Rect(gridborder_x, gridborder_y, self.width_grid_border, self.height_grid_border)
        pygame.draw.rect(self.surface, GameUI.GRID_BORDER_COLOR, gridborder_rect, 3)

        gridcontainer_x = gridborder_x + self.padding_grid_border
        gridcontainer_y = gridborder_y + self.padding_grid_border
        gridcontainer_rect = pygame.Rect(gridcontainer_x, gridcontainer_y, self.width_grid_container, self.height_grid_container)
        pygame.draw.rect(self.surface, GameUI.GRID_LINE_COLOR, gridcontainer_rect, 1)

        # ===============================
        # 2. Create sidebar container
        # ===============================
        sidebar_x = gridborder_rect.right + self.padding_grid["right"]
        sidebar_y = gridborder_y
        sidebar_rect = pygame.Rect(sidebar_x, sidebar_y, self.width_sidebar_container, self.height_sidebar_container)
        ...
        sidebar_containers = [
            ...
            pygame.Rect(
                sidebar_x,
                sidebar_y + sidebar_total_height * 0.25 + self.sidebar_box_spacing,
                self.width_sidebar_container,
                sidebar_total_height * 0.25
            ),
            pygame.Rect(
                sidebar_x,
                sidebar_y + sidebar_total_height * 0.5 + 2 * self.sidebar_box_spacing,
                self.width_sidebar_container,
                sidebar_total_height * 0.5
            )
        ]
        for rect in sidebar_containers:
            pygame.draw.rect(self.surface, GameUI.GRID_BORDER_COLOR, rect, 3)
        ...
        for row in range(self.controller.game_board.num_rows):
            for col in range(self.controller.game_board.num_cols):
                x = gridcontainer_x + col * self.size_block
                y = gridcontainer_y + row * self.size_block
        ...
        for r in range(self.controller.game_board.num_rows + 1):
            y = gridcontainer_y + r * self.size_block
            pygame.draw.line(self.surface, GameUI.GRID_LINE_COLOR, (gridcontainer_x, y), (gridcontainer_x + gridcontainer_rect.width, y), 5)
        for c in range(1, self.controller.game_board.num_cols):
            x = gridcontainer_x + c * self.size_block
            pygame.draw.line(self.surface, GameUI.GRID_LINE_COLOR, (x, gridcontainer_y), (x, gridcontainer_y + gridcontainer_rect.height), 5)
        ...
        gameinfo_texts = {
            1: {"value": "Score", "font": GameUI.HEADER_FONT, "color": GameUI.HEADER_TEXT_COLOR, "bold": True},
            2: {"value": str(self.controller.points), "font": GameUI.SUBHEADER_FONT, "color": GameUI.SUBHEADER_TEXT_COLOR, "bold": False},
            3: {"value": "Level", "font": GameUI.HEADER_FONT, "color": GameUI.HEADER_TEXT_COLOR, "bold": True},
            4: {"value": str(self.controller.level), "font": GameUI.SUBHEADER_FONT, "color": GameUI.SUBHEADER_TEXT_COLOR, "bold": False},
            5: {"value": "Rows Cleared", "font": GameUI.HEADER_FONT, "color": GameUI.HEADER_TEXT_COLOR, "bold": True},
            6: {"value": str(self.controller.total_rows_cleared), "font": GameUI.SUBHEADER_FONT, "color": GameUI.SUBHEADER_TEXT_COLOR, "bold": False},
        }
        ...
        for panel in info_panels:
            # pygame.draw.rect(self.surface, COLORS["WHITE"], panel, 2) # NOTE: SCAFFOLDING
            ...
            for rect in text_boxes:
                # pygame.draw.rect(self.surface, COLORS["MAGENTA"], rect, 2) # NOTE: SCAFFOLDING
                ...
                font_size = int(min(max_width, max_height) * 0.65)
        ...
        for r, row in enumerate(matrix):
            for c, val in enumerate(row):
                if val != 0:
                    ...
                    pygame.draw.rect(self.surface, GameUI.GRID_LINE_COLOR, rect, 3)
